...
export const products: Product[] = [
  {
    ...
    description:
      "The Travis Scott x Air Jordan 1 Retro Low OG SP features a unique velvet brown upper with premium materials and signature details. This collaboration brings together the iconic Jordan 1 silhouette with Travis Scott's distinctive style.",
    brand: "Nike",
    category: "Sneakers",
